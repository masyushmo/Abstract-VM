...
/*   Updated: 2019/12/02 15:47:56 by mmasyush         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    return "\033[0;31mLexical error\033[0;37m";
}
...
{
    return "\033[0;31mDivision by 0 error\033[0;37m";
}

const char * Ex_ModByZero::what() const throw()
{
    return "\033[0;31mModul by 0 error\033[0;37m";
}
...
{
    return "\033[0;31mAn assert instruction is not true\033[0;37m";
}
...
{
    return "\033[0;31mCan't print symbol\033[0;37m";
}